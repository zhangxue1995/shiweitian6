...
public class ListViewAdapter_feed extends BaseAdapter {
    ...
    public ListViewAdapter_feed(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_feed.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_feed.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_feedback, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_feed.ListItemView)convertView.getTag();
        }
