...
public class ListViewAdapter_report extends BaseAdapter {
    ...
    public ListViewAdapter_report(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_report.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_report.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_report, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_report.ListItemView)convertView.getTag();
        }
