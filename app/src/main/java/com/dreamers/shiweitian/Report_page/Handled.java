...
public class Handled extends AppCompatActivity {

    private ListView listView;
    private ListViewAdapter_myreport listViewAdapter;
    private List<Map<String, Object>> listItems;
    private String[] title1 = {"海底捞（凯德广场店）","德芙巧克力（308g）"};
    private String[] title2 = {"2017年1月3日","2016年11月11日"};
    private String[] title3 = {"菌汤有股苦霉味，辣锅有一丢丢红油飘在上面，菜品不新鲜，羊肉口感很奇怪。",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                it.setClass(Handled.this, Feedback_detail.class);
                it.putExtra("str1","已受理");//给intent添加额外数据，key为“str”,key值为"Intent Demo"
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Handled.this.finish(); // back button
                return true;
        }
