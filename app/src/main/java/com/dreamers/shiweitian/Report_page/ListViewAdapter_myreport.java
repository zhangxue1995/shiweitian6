...
public class ListViewAdapter_myreport extends BaseAdapter {
    ...
    public ListViewAdapter_myreport(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_myreport.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_myreport.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_myreport, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_myreport.ListItemView)convertView.getTag();
        }
