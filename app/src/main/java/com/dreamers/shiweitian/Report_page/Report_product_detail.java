...
public class Report_product_detail extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(Report_product_detail.this)
                        .setTitle("头像选择")
                        .setView(view)
...
//			            pickIntent.setDataAndType(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, image/png);
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(user.isLogin()==true) {
                            ...
                            it.setClass(Report_product_detail.this, Login_page.class);
    ...
    Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(Report_product_detail.this, string, Toast.LENGTH_LONG).show();
            editText1.setText("");
            editText2.setText("");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Report_product_detail.this.finish(); // back button
                return true;
        }
