...
public class ListViewAdapter_nearby extends BaseAdapter {
    ...
    public ListViewAdapter_nearby(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_nearby.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_nearby.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_nearby, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_nearby.ListItemView)convertView.getTag();
        }
