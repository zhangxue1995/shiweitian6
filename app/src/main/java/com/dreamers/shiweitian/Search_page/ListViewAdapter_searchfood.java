...
public class ListViewAdapter_searchfood extends BaseAdapter {
    ...
    public ListViewAdapter_searchfood(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_searchfood.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_searchfood.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_searchfood, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_searchfood.ListItemView)convertView.getTag();
        }
