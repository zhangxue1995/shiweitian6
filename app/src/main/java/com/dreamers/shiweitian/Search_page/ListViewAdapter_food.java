...
public class ListViewAdapter_food extends BaseAdapter {
    ...
    public ListViewAdapter_food(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_food.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_food.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_food, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_food.ListItemView)convertView.getTag();
        }
