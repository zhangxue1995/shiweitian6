...
public class ListViewAdapter_healthcolumn extends BaseAdapter {
    ...
    public ListViewAdapter_healthcolumn(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_healthcolumn.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_healthcolumn.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_healthcolumn, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_healthcolumn.ListItemView)convertView.getTag();
        }
