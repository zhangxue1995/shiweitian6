...
public class ListViewAdapter_foodmonitoringnews extends BaseAdapter {
    ...
    public ListViewAdapter_foodmonitoringnews(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_foodmonitoringnews.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_foodmonitoringnews.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_foodmonitoringnews, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_foodmonitoringnews.ListItemView)convertView.getTag();
        }
