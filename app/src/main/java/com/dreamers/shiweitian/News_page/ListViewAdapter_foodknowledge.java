...
public class ListViewAdapter_foodknowledge extends BaseAdapter {
    ...
    public ListViewAdapter_foodknowledge(Context context, List<Map<String, Object>> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //自定义视图
        ListViewAdapter_foodknowledge.ListItemView listItemView = null;
        if (convertView == null) {
            listItemView = new ListViewAdapter_foodknowledge.ListItemView();
            //获取list_item布局文件的视图
            convertView = listContainer.inflate(R.layout.list_item_foodknowledge, null);
            //获取控件对象
            ...
            listItemView = (ListViewAdapter_foodknowledge.ListItemView)convertView.getTag();
        }
